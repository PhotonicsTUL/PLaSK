    ...
    def parse_name(self):
        ...
        *self.args* and *self.retann* if parsing and resolving was successful.
        ...
        if len(_match_groups) == 5:
            explicit_modname, path, base, args, retann = _match_groups
        elif len(_match_groups) == 6:
            explicit_modname, path, base, tp_list, args, retann = _match_groups
        else:
            self.directive.warn('Wrong number of groups in signature regex. '
                                'See changes in Sphinx.')
            return False
