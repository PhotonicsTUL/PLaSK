...
sys.path.insert(0, os.path.abspath('../../debug/lib/plask/python'))
sys.path.insert(0, os.path.abspath('../../release/lib/plask/python'))
sys.path.insert(0, os.path.abspath('../../build/lib/plask/python'))
sys.path.insert(0, os.path.abspath('../../build-release/lib/plask/python'))
