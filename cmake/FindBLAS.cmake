...
if (NOT _libdir)
  if (WIN32)
    set(_libdir ${CMAKE_LIBRARY_PATH} ENV LIB)
  elseif (APPLE)
    set(_libdir /usr/local/lib /usr/lib /usr/local/lib64 /usr/lib64 ${CMAKE_LIBRARY_PATH} ENV DYLD_LIBRARY_PATH)
  else ()
    set(_libdir /usr/local/lib /usr/lib /usr/local/lib64 /usr/lib64 ${CMAKE_LIBRARY_PATH} ENV LD_LIBRARY_PATH)
  endif ()
endif ()
