...
class Launcher(QObject):
    ...
    def widget(self, main_window, parent=None):
        ...
        dirbutton.pressed.connect(
            lambda: self.select_workdir(main_window.document.filename)
        )
        ...
        if self.dirname:
            ...
            dirname = os.path.dirname(
                os.path.abspath(main_window.document.filename or "dummy")
            )
        ...
        pal.setColor(
            ...
            QPalette().color(QPalette.ColorGroup.Normal,
        ...
        try:
            loglevel = [
                ...
                'result', 'data', 'detail', 'debug'
            ].index(main_window.document.loglevel.lower())
        except Exception:
            loglevel = 6
    ...
    def launch(self, main_window, args, defs, debugger=None):
        ...
        try:
            bottom_docked = [
                ...
                if main_window.dockWidgetArea(w)
