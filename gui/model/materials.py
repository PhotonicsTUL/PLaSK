...
MATERIALS_PROPERTES = {
    ...
    'Mlh': (u'Light hole effective mass <i>M<sub>lh</sub></i> in lateral '
             u'and verical directions', u'<i>m</i><sub>0</sub>',
             [(u'T', u'temperature', u'K'), (u'e', u'lateral strain', '-')]),
    'mob': (u'Majority carriers mobility <i>µ</i> in lateral and vertical directions', u'cm<sup>2</sup>/Vs',
              [(u'T', u'temperature', u'K')]),
    'mobe': (u'Electron mobility <i>µ</i><sub><i>e</i></sub> in lateral and vertical directions', u'cm<sup>2</sup>/Vs',
              [(u'T', u'temperature', u'K')]),
    'mobh': (u'Hole mobility <i>µ</i><sub><i>h</i></sub> in lateral and vertical directions', u'cm<sup>2</sup>/Vs',
              [(u'T', u'temperature', u'K')]),
