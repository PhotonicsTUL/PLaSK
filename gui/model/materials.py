...
MATERIALS_PROPERTES = OrderedDict((
    ...
    ('EactD', (u'Donor ionization energy <i>E</i><sub>actD</sub>', u'eV',
               [(u'T', u'temperature', 'K')])),
    ('Eg', (u'Energy band gap <i>E<sub>g</sub></i>', u'eV',
            [(u'T', u'temperature', 'K'),
             (u'e', u'lateral strain', '-'),
             (u'point', u'point in the Brillouin zone', '-')])),
    ...
    ('mob', (u'Majority carriers mobility <i>µ</i> in lateral and vertical directions', u'cm<sup>2</sup>/(V s)',
              [(u'T', u'temperature', 'K')])),
    ('mobe', (u'Electron mobility <i>µ<sub>e</sub></i> in lateral and vertical directions', u'cm<sup>2</sup>/(V s)',
              [(u'T', u'temperature', 'K')])),
    ('mobh', (u'Hole mobility <i>µ<sub>h</sub></i> in lateral and vertical directions', u'cm<sup>2</sup>/(V s)',
              [(u'T', u'temperature', 'K')])),
    ('Mso', (u'Split-off mass <i>M</i><sub>so</sub>', u'<i>m</i><sub>0</sub>',
             [(u'T', u'temperature', 'K'),
              (u'e', u'lateral strain', '-')])),
    ('Na', (u'Acceptor concentration <i>N<sub>a</sub></i>', u'cm<sup>-3</sup>', [])),
    ('Nd', (u'Donor concentration <i>N<sub>d</sub></i>', u'cm<sup>-3</sup>', [])),
