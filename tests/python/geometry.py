...
class GeometryObjects(unittest.TestCase):
    ...
    def setUp(self):
        self.mat = plask.material.Material()
    ...
    def testRectangle(self):
        ...
        try:
            ...
            self.assertEqual( self.rectangle53.getMaterial(plask.vec(6.0, 2.0)), None);
    ...
    def testTranslation(self):
        ...
        try:
            ...
            self.assertEqual( translation.getMaterial(4.0, 22.0), None);
    ...
    def testMultiStack(self):
        ...
        try:
            ...
            self.assertEqual( multistack.getMaterial(4.0, 41.0), None )
