...
py::list testBoundary(const plask::RectangularMeshBase2D& mesh, const plask::shared_ptr<const plask::GeometryD<2>>& geometry,
                      const typename plask::RectangularMeshBase2D::Boundary& boundary) {
    py::list result;
