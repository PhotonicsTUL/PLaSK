...
BOOST_AUTO_TEST_CASE(from_geometry_3) {
    ...
    stack->push_back(cub1, plask::align::LongCenter(0.0) & plask::align::TranCenter(0.0));
    stack->push_back(cub2, plask::align::LongCenter(0.0) & plask::align::TranCenter(0.0));
    stack->push_back(cub3, plask::align::LongCenter(0.0) & plask::align::TranCenter(0.0));
...
BOOST_AUTO_TEST_CASE(generator) {
    plask::RectilinearMesh2DDivideGenerator generator;
