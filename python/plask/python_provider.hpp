...
template <typename PropertyT> struct PropertyArgsSingleValue {
    static py::detail::keywords<1> value() { return py::arg("self"); }
};

template <typename PropertyT> struct PropertyArgsMultiValue {
    static py::detail::keywords<2> value() { return py::arg("self"), py::arg("n"); }
};
...
template <typename PropertyTag> static constexpr const char* docstring_provider() {
...
template <typename T, int dim> struct PythonDataVector : public DataVector<T> {
    ...
    PythonDataVector(const PythonDataVector<T, dim>& src) : DataVector<T>(src), mesh(src.mesh), mesh_changed(src.mesh_changed) {
        if (mesh) mesh->changedConnectMethod(this, &PythonDataVector<T, dim>::onMeshChanged);
    }

    template <typename TS>
    PythonDataVector(const PythonDataVector<TS, dim>& src) : DataVector<T>(src), mesh(src.mesh), mesh_changed(src.mesh_changed) {
        if (mesh) mesh->changedConnectMethod(this, &PythonDataVector<T, dim>::onMeshChanged);
    }
...
template <typename ProviderT, PropertyType propertyType, typename ParamsT> struct PythonProviderFor;
...
template <typename ReceiverT> struct RegisterReceiverBase {
    ...
    template <typename GeometryT> static void connect_transformed(ReceiverT& receiver, py::object oprovider) {
    ...
    static void __set__(ReceiverT& self, const py::object&, const py::object& value) { RegisterT::setter(self, value); }
    ...
    RegisterReceiverBase(const std::string& suffix = "", const std::string& space = "")
        : property_name(type_name<PropertyT>()),
          receiver_class((property_name + "Receiver" + suffix).c_str(),
                         format(docstring_receiver,
                                property_name,
                                suffix,
                                ReceiverT::ProviderType::PropertyTag::NAME,
                                (space != "") ? " in " + space + " geometry" : "",
                                ReceiverT::ProviderType::PropertyTag::UNIT)
                             .c_str()) {
...
static typename std::enable_if<std::is_same<typename ReceiverT::SpaceType, void>::value, bool>::type assignProvider(
    ReceiverT& receiver,
    const py::object& obj) {
    try {
...
template <typename ReceiverT>
static typename std::enable_if<std::is_same<typename ReceiverT::SpaceType, Geometry3D>::value, bool>::type assignProvider(
    ReceiverT& receiver,
    const py::object& obj) {
    try {
        RegisterReceiverBase<ReceiverT>::connect(receiver, obj);
    ...
    try {
        RegisterReceiverBase<ReceiverT>::template connect_transformed<Geometry2DCartesian>(receiver, obj);
        return true;
    } catch (py::error_already_set&) {
        PyErr_Clear();
    }
    try {
        RegisterReceiverBase<ReceiverT>::template connect_transformed<Geometry2DCylindrical>(receiver, obj);
        return true;
    } catch (py::error_already_set&) {
        PyErr_Clear();
    }
...
template <typename ReceiverT>
static typename std::enable_if<std::is_same<typename ReceiverT::SpaceType, Geometry2DCartesian>::value, bool>::type assignProvider(
    ReceiverT& receiver,
    const py::object& obj) {
    try {
        RegisterReceiverBase<ReceiverT>::connect(receiver, obj);
    ...
    try {
        RegisterReceiverBase<ReceiverT>::template connect_transformed<Geometry3D>(receiver, obj);
        return true;
    } catch (py::error_already_set&) {
        PyErr_Clear();
    }
...
template <typename ReceiverT>
static typename std::enable_if<std::is_same<typename ReceiverT::SpaceType, Geometry2DCylindrical>::value, bool>::type
...
template <typename ReceiverT> static bool assignValue(ReceiverT& receiver, const py::object& obj) {
...
template <typename ReceiverT> static bool assignMultipleValues(ReceiverT& receiver, const py::object& obj) {
...
struct RegisterReceiverImpl<ReceiverT, MULTI_VALUE_PROPERTY, VariadicTemplateTypesHolder<ExtraParams...>>
    ...
    RegisterReceiverImpl() {
        ...
        this->receiver_class.def("__call__", &__call__n, PropertyArgsMultiValue<PropertyT>::value(),
                                 u8"Get value from the connected provider");
        this->receiver_class.def("__len__", (size_t(ReceiverT::*)() const) & ReceiverT::size,
                                 u8"Get number of values from connected provider");
    }
};
...
struct RegisterReceiverImpl<ReceiverT, FIELD_PROPERTY, VariadicTemplateTypesHolder<ExtraParams...>>
    ...
    typedef typename ReceiverT::PropertyTag PropertyT;
    typedef typename ReceiverT::ValueType ValueT;
    static constexpr int DIMS = ReceiverT::SpaceType::DIM;
    ...
    static DataT __call__(ReceiverT& self,
    ...
    RegisterReceiverImpl()
        : RegisterReceiverBase<ReceiverT>(spaceSuffix<typename ReceiverT::SpaceType>(),
  ...
  private:
    template <typename MeshT> static inline bool setValueForMesh(ReceiverT& self, const shared_ptr<Mesh>& msh, const DataT& data) {
        shared_ptr<MeshT> mesh = dynamic_pointer_cast<MeshT>(msh);
        if (mesh) {
            self.setValue(data, mesh);
            return true;
        }
        return false;
    }
...
struct RegisterReceiverImpl<ReceiverT, MULTI_FIELD_PROPERTY, VariadicTemplateTypesHolder<ExtraParams...>>
    ...
    static void setter(ReceiverT& self, const py::object& obj) {
        ...
        if (assignProvider(self, obj)) return;
        if (assignValue(self, obj)) return;
        if (PyTuple_Check(obj.ptr()) && assignMultipleValues(self, obj)) return;
        if (PyTuple_Check(obj.ptr()) ||
            py::extract<PythonDataVector<const typename ReceiverT::ValueType, ReceiverT::SpaceType::DIM>>(obj).check()) {
            auto data = plask::make_shared<
                PythonProviderFor<ProviderT, PropertyT::propertyType, VariadicTemplateTypesHolder<ExtraParams...>>>(obj);
            if (assignProvider(self, py::object(data))) return;
        }
    ...
    static DataT __call__n(ReceiverT& self,
                           EnumType n,
                           const shared_ptr<MeshD<DIMS>>& mesh,
                           const ExtraParams&... params,
                           InterpolationMethod method) {
    ...
    static DataT __call__0(ReceiverT& self,
                           const shared_ptr<MeshD<DIMS>>& mesh,
                           const ExtraParams&... params,
                           InterpolationMethod method) {
...
template <typename Class, typename ClassT, typename ReceiverT> struct ReceiverSetter {
    ...
    void operator()(Class& self, py::object obj) { RegisterT::setter(self.*field, obj); }
...
PythonDataVector<T, dim> PLASK_PYTHON_API dataInterpolate(const PythonDataVector<T, dim>& src,
                                                          shared_ptr<MeshD<dim>> dst_mesh,
                                                          InterpolationMethod method,
                                                          const py::object& geometry = py::object());

template <typename T> struct PythonLazyDataImpl : public LazyDataImpl<T> {
    py::object object;
    size_t len;
...
struct PythonProviderFor<ProviderT, FIELD_PROPERTY, VariadicTemplateTypesHolder<_ExtraParams...>>
    ...
    PythonProviderFor(const py::object& function)
        : ProviderFor<typename ProviderT::PropertyTag, typename ProviderT::SpaceType>::Delegate(
              [this](const shared_ptr<const MeshD<ProviderT::SpaceType::DIM>>& dst_mesh,
                  ...
                  if (PyCallable_Check(this->function.ptr())) {
                      ...
                      return detail::parseProviderReturnedValue<typename ProviderT::ValueType, ProviderT::SpaceType::DIM>(result,
                                                                                                                          omesh);
                  } else {
...
struct PythonProviderFor<ProviderT, MULTI_FIELD_PROPERTY, VariadicTemplateTypesHolder<_ExtraParams...>>
    ...
    PythonProviderFor(const py::object& function)
        : ProviderFor<typename ProviderT::PropertyTag, typename ProviderT::SpaceType>::Delegate(
              [this](typename ProviderT::EnumType n,
...
PythonProviderFor__init__(const py::object& function) {
    return plask::make_shared<
        PythonProviderFor<ProviderT, ProviderT::PropertyTag::propertyType, typename ProviderT::PropertyTag::ExtraParams>>(function);
}

// ---------- Combined Provider ------------
template <typename CombinedProviderT> struct RegisterCombinedProvider {
    typedef py::class_<CombinedProviderT,
                       py::bases<ProviderFor<typename CombinedProviderT::PropertyTag, typename CombinedProviderT::SpaceType>>,
                       boost::noncopyable>
        Class;
    ...
    static void __iadd__(py::object pyself, typename CombinedProviderT::BaseType* provider) { __add__(pyself, provider); }

    static CombinedProviderT* add(typename CombinedProviderT::BaseType* provider1,
                                  typename CombinedProviderT::BaseType* provider2) {
    ...
    RegisterCombinedProvider(const std::string& name) {
        ...
        py::def("__add__", &add,
                py::with_custodian_and_ward_postcall<
                    0, 1, py::with_custodian_and_ward_postcall<0, 2, py::return_value_policy<py::manage_new_object>>>());
    }
};
...
//     py::handle<> cls;
//
//     typedef py::class_<ScaledProviderT, py::bases<ProviderFor<typename ScaledProviderT::PropertyTag, typename
//     ScaledProviderT::SpaceType>>, boost::noncopyable> Class;
//
    ...
    RegisterProviderBase(const std::string& suffix = "", const std::string& space = "")
        ...
        py::class_<PythonProviderType, shared_ptr<PythonProviderType>, py::bases<ProviderT>, boost::noncopyable>(
            ...
            format(docstring_provider<typename ProviderT::PropertyTag>(), property_name, suffix,
                   ProviderT::PropertyTag::NAME,                                             // {0} Gain, {1} 2D, {2} Gain
            ...
            py::no_init)
            .def("__init__",
                 py::make_constructor(PythonProviderFor__init__<ProviderT>, py::default_call_policies(), py::args("data")))
...
struct RegisterProviderImpl<ProviderT, SINGLE_VALUE_PROPERTY, VariadicTemplateTypesHolder<ExtraParams...>>
    ...
    RegisterProviderImpl() {
        this->provider_class.def(
            "__call__", &__call__, PropertyArgsSingleValue<PropertyT>::value(),
...
struct RegisterProviderImpl<ProviderT, MULTI_VALUE_PROPERTY, VariadicTemplateTypesHolder<ExtraParams...>>
    ...
    RegisterProviderImpl() {
        ...
        this->provider_class.def(
            "__call__", &__call__n, PropertyArgsMultiValue<PropertyT>::value(),
...
struct RegisterProviderImpl<ProviderT, FIELD_PROPERTY, VariadicTemplateTypesHolder<ExtraParams...>>
    ...
    RegisterProviderImpl()
        : RegisterProviderBase<ProviderT>(spaceSuffix<typename ProviderT::SpaceType>(),
                                          spaceName<typename ProviderT::SpaceType>()) {
...
template <typename ReceiverT> inline void registerReceiver() {
    if (py::converter::registry::lookup(py::type_id<ReceiverT>()).m_class_object == nullptr) {
        py::scope scope = flow_module;
        (void)scope;  // don't warn about unused variable scope
        detail::RegisterReceiverImpl<ReceiverT, ReceiverT::PropertyTag::propertyType,
                                     typename ReceiverT::PropertyTag::ExtraParams>();
    }
}
...
template <typename ProviderT> void registerProvider() {
    if (py::converter::registry::lookup(py::type_id<ProviderT>()).m_class_object == nullptr) {
        py::scope scope = flow_module;
        (void)scope;  // don't warn about unused variable scope
        detail::RegisterProviderImpl<ProviderT, ProviderT::PropertyTag::propertyType,
                                     typename ProviderT::PropertyTag::ExtraParams>();
    }
}
