...
void register_geometry_primitive()
{
    ...
    py::class_<Box2D, shared_ptr<Box2D>>("Box2D",
        ...
        .add_property("left", &Box2D::left, "Left edge of the box")
        .add_property("right", &Box2D::right, "Right edge of the box")
        .add_property("top", &Box2D::top, "Top edge of the box")
        .add_property("bottom", &Box2D::bottom, "Bottom edge of the box")
    ...
    py::class_<Box3D, shared_ptr<Box3D>>("Box3D",
        ...
        .add_property("front", &Box3D::front, "Front edge of the box")
        .add_property("back", &Box3D::back, "Back edge of the box")
        .add_property("left", &Box3D::left, "Left edge of the box")
        .add_property("right", &Box3D::right, "Right edge of the box")
        .add_property("top", &Box3D::top, "Top edge of the box")
        .add_property("bottom", &Box3D::bottom, "Bottom edge of the box")
