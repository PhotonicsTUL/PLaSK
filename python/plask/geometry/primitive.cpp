...
void register_geometry_primitive()
{
    ...
    py::class_<Rect2d, shared_ptr<Rect2d>>("Box2D",
        ...
        .def("__init__", py::make_constructor(&Rect2d_constructor_2vec, py::default_call_policies(), (py::arg("lower"), py::arg("upper"))))
        .def("__init__", py::make_constructor(&Rect2d_constructor_4numbers, py::default_call_policies(), (py::arg("l0"), py::arg("l1"), py::arg("u0"), py::arg("u1"))))
    ...
    py::class_<Rect3d, shared_ptr<Rect3d>>("Box3D",
        ...
        .def("__init__", py::make_constructor(&Rect3d_constructor_2vec, py::default_call_policies(), (py::arg("lower"), py::arg("upper"))))
        .def("__init__", py::make_constructor(&Rect3d_constructor_4numbers, py::default_call_policies(), (py::arg("l0"), py::arg("l1"), py::arg("l2"), py::arg("u0"), py::arg("u1"), py::arg("u2"))))
