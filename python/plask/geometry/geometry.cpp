...
// shared_ptr<Manager> Geometry__init__(py::tuple args, py::dict kwargs) {
//
//     std::string filename="";
...
// }
//
// shared_ptr<GeometryElement> Geometry_element(Manager& self, const char* key) {
//     shared_ptr<GeometryElement> result = self.getGeometryElement(key);
...
//     py::class_<Manager, boost::noncopyable>("GeometryReader",
