...
void register_geometry_leafs()
{
    ...
    py::class_<Cuboid, shared_ptr<Cuboid>, py::bases<GeometryObjectLeaf<3>>, boost::noncopyable> block3D("Cuboid",
        ...
        .add_property("depth", &Block__getdim<3,0>, &Block__setdim<3,0>, "Depth of the rectangle")
        .add_property("width", &Block__getdim<3,1>, &Block__setdim<3,1>, "Width of the rectangle")
        .add_property("height", &Block__getdim<3,2>, &Block__setdim<3,2>, "Height of the rectangle")
