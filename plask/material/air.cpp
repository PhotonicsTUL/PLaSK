...
double Air::CBO(double T, double eps, char point) const { throwNotApplicable("CBO(double T, double eps, char point)"); return 0; }

double Air::chi(double T, double eps, char point) const { throwNotApplicable("chi(double T, double eps, char point)"); return 0; }
...
double Air::Dso(double T, double eps) const { throwNotApplicable("Dso(double T, double eps)"); return 0; }
...
double Air::Eg(double T, double eps, char point) const { throwNotApplicable("Eg(double T, double eps, char point)"); return 0; }
...
Tensor2<double> Air::Me(double T, double eps, char point) const { throwNotApplicable("Me(double T, double eps, char point)"); return 0.; }

Tensor2<double> Air::Mh(double T, double eps, char point) const { throwNotApplicable("Mh(double T, double eps, char point)"); return 0.; }

Tensor2<double> Air::Mhh(double T, double eps, char point) const { throwNotApplicable("Mhh(double T, double eps, char point)"); return 0.; }

Tensor2<double> Air::Mlh(double T, double eps, char point) const { throwNotApplicable("B(double T)"); return 0.; }

Tensor2<double> Air::mob(double T) const { throwNotApplicable("mob(double T)"); return 0.; }

double Air::Mso(double T, double eps) const { throwNotApplicable("Mso(double T, double eps)"); return 0; }

double Air::Nc(double T, double eps, char point) const { throwNotApplicable("Nc(double T, double eps, char point)"); return 0; }
double Air::Nc(double T, double eps) const { throwNotApplicable("Nc(double T, double eps)"); return 0; }
...
double Air::VBO(double T, double eps, char point) const { throwNotApplicable("VBO(double T, double eps, char point)"); return 0; }
