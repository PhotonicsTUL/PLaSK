...
struct Air: public Material {
    ...
    virtual double VBO(double T, double eps, char point) const;
    virtual double Dso(double T, double eps) const;
    virtual double Mso(double T, double eps) const;
    ...
    virtual Tensor2<double> Mh(double T, double eps, char point) const;
    virtual double eps(double T) const;
    virtual double chi(double T, double eps, char point) const;
    virtual double Nc(double T, double eps, char point) const;
    virtual double Nc(double T, double eps) const;
