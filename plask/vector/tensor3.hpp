...
template <typename T> struct Tensor3 {
    ...
    //  * \return squared tensor
    //  */
    // template <typename OtherT> Tensor3<T> pow(OtherT a) const {
    ...
    Tensor3<T> inv() const {
        // clang-format off
        dcomplex a00 = c11*c22 - c12*c21,  a01 = c02*c21 - c01*c22,  a02 = c01*c12 - c02*c11,
                 a10 = c12*c20 - c10*c22,  a11 = c00*c22 - c02*c20,  a12 = c02*c10 - c00*c12,
                 a20 = c10*c21 - c11*c20,  a21 = c01*c20 - c00*c21,  a22 = c00*c11 - c01*c10;
        // clang-format on

        dcomplex det = c00 * c11 * c22 + c01 * c12 * c20 + c02 * c10 * c21 - c02 * c11 * c20 - c00 * c12 * c21 - c10 * c01 * c22;
        return Tensor3<T>(a00 / det, a11 / det, a22 / det, a01 / det, a02 / det, a12 / det);
    }
...
template <typename T> inline bool is_zero(const Tensor3<T>& v) {
    return is_zero(v.c00) && is_zero(v.c01) && is_zero(v.c02) &&
           is_zero(v.c10) && is_zero(v.c11) && is_zero(v.c12) &&
...
namespace std {
template <typename T> plask::Tensor3<T> sqrt(plask::Tensor3<T> tens) { return tens.sqrt(); }

// template <typename T, typename OtherT> plask::Tensor3<T> pow(plask::Tensor3<T> tens, OtherT a) { return tens.pow(a); }
}  // namespace std
