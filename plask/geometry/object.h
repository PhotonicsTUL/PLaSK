...
protected:
    ...
    void fireChildrenRemoved(std::size_t beginIndex, std::size_t endIndex) {
        this->fireChanged<ChildrenListChangedEvent>(GeometryObject::Event::RESIZE | GeometryObject::Event::CHILDREN_REMOVE, beginIndex, endIndex);
    }

    void fireChildrenInserted(std::size_t beginIndex, std::size_t endIndex) {
        this->fireChanged<ChildrenListChangedEvent>(GeometryObject::Event::RESIZE | GeometryObject::Event::CHILDREN_INSERT, beginIndex, endIndex);
    }
...
struct GeometryObjectD: public GeometryObject {
    ...
    /**
     * Calculate bounding boxes of all objects, marked by path.
     * @param path path fragments
