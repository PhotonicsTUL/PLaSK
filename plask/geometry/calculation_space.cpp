...
void Space2dCartesian::setBorders(int direction, const border::Strategy& border_to_set) {
    Primitive<2>::ensureIsValidDirection(direction);
    if (direction == Primitive<2>::DIRECTION_TRAN)
        leftright.setBoth(border_to_set);
    else
        bottomup.setBoth(border_to_set);
}

void Space2dCartesian::setBorder(int direction, bool higher, const border::Strategy& border_to_set) {
    Primitive<2>::ensureIsValidDirection(direction);
    if (direction == Primitive<2>::DIRECTION_TRAN)
...
const border::Strategy& Space2dCartesian::getBorder(int direction, bool higher) const {
    Primitive<2>::ensureIsValidDirection(direction);
    return (direction == Primitive<2>::DIRECTION_TRAN) ? leftright.get(higher) : bottomup.get(higher);
}
...
void Space2dCylindrical::setBorders(int direction, const border::Strategy& border_to_set) {
    Primitive<2>::ensureIsValidDirection(direction);
    if (direction == Primitive<2>::DIRECTION_TRAN)
...
void Space2dCylindrical::setBorder(int direction, bool higher, const border::Strategy& border_to_set) {
...
const border::Strategy& Space2dCylindrical::getBorder(int direction, bool higher) const {
    ensureBoundDirIsProper(direction, higher);
    return (direction == Primitive<2>::DIRECTION_TRAN) ? outer.getStrategy() : bottomup.get(higher);
}
