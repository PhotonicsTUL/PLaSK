...
struct StackContainer: public StackContainerBaseImpl<dim> {
    ...
    typedef typename chooseType<dim-2, align::AxisAligner<Primitive<3>::DIRECTION_TRAN>, align::Aligner3D<Primitive<3>::DIRECTION_LONG, Primitive<3>::DIRECTION_TRAN> >::type Aligner;
