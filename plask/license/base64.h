 ...
 * @return encoded string
 */
inline std::string encode(const std::string& string_to_encode) {
    return encode(reinterpret_cast<unsigned char const* >(string_to_encode.c_str()), string_to_encode.size());
}
