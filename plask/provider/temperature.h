 ...
 * struct Module1 {
 *      plask::ProviderFor<Temperature, plask::Cartesian2d>::Delegate temperatureProvider;
 * 
 *      plask::shared_ptr< const std::vector<ValueT> > getTemperature(const plask::Mesh<plask::Cartesian2d>& dst_mesh, plask::InterpolationMethod method) {
 *              //calculate and return temperature code
 *      }
 *      //...
 *      Module1(): temperatureProvider(&Module1::getTemperature) {}
 * };
 * 
 * //needs temperature in Cartesian 2d space:
 * struct Module2 {
 *      plask::ReceiverFor<Temperature, plask::Cartesian2d> temperatureReceiver;
 *      //...
 * };
 * 
 * //... in program:
 * Module1 m1;
 * Module1 m2;
 * m1.temperatureReceiver = m2.temperatureProvider;
 * @endcode
 * 
