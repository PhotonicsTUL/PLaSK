...
//         const RegularMesh1d& mesh;
//         size_t idx;
//       public:
//         const_iterator(const RegularMesh1d& mesh) : mesh(mesh), idx(0) {}
//         const_iterator(const RegularMesh1d& mesh, size_t idx) : mesh(mesh), idx(idx) {}
//     };
//
...
//      */
//     RegularMesh1d(std::initializer_list<PointType> points);
//
//     /**
...
//      * @param points points, in any order
//      */
//     RegularMesh1d(std::vector<PointType> points);
//
//     /**
//      * Compares meshes
...
//
// template <typename IteratorT>
// inline void RegularMesh1d::addOrderedPoints(IteratorT begin, IteratorT end, std::size_t points_count_hint) {
