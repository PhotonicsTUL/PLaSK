...
It can be one of: plask::space::Cartesian2d (2D Cartesian coordinates), plask::space::Cylindrical2d (2D cylindrical coordinates) or plask::space::Cartesian3d (3D cooridinates).
You are required to:
...
You can specialize adapter template to generate class which inheriting from plask::Mesh.
