...
struct SpaceXY {
    ...
    // inline static Vec3<double> ABC(const Vec2<double>& xy, double z=0.) {
    //     return Vec3<double>(z, xy.x, xy.y);
    // }
    // /// Convert local to global coordinates
    ...
    // }
    // /// Convert local to global coordinates
    // inline static Vec3<double> ABC(double x, double y, double z=0.) {
    ...
    // inline static Vec2<double> local(Args&&... args) {
    //     return XY(args...);
    // }
    //
...
struct SpaceRZ {
    ...
    // }
    // /// Convert local to global coordinates
    // inline static Vec3<double> ABC(const Vec3<double>& abc) {
    //     return Vec3<double>(abc.r*cos(abc.phi), abc.r*sin(abc.phi), abc.z);
    // }
    // /// Convert local to global coordinates
    ...
    // }
    // /// Convert local to global coordinates
    // inline static Vec3<double> ABC(const Vec2<double>& rz, double phi) {
    //     return Vec3<double>(rz.r*cos(phi), rz.r*sin(phi), rz.z);
    // }
    //
    // /// Convert global to local coordinates
    ...
    // template<typename T>
    // inline static const Vec3<T> inABC(const Vec3<T>& v_abc) {
    //     return v_abc;
    // }
    // /// Convert 3D vector components from local to global coordinates for any φ.
    // template<typename T>
    // inline static const Vec3<T> inABC(const Vec3<T>& v_abc, double phi) {
    //     register double s = sin(phi), c = cos(phi);
    //     return Vec3<double>( v_abc.r*c - v_abc.phi*s, v_abc.r*s + v_abc.phi*c, v_abc.z);
    // }
    // /// Convert 3D vector components from local to global coordinates in any point
    // template<typename T>
    // inline static const Vec3<T> inABC(const Vec3<T>& v_abc, const Vec3<double>& abc) {
    //     register double phi = atan2(abc.b, abc.a);
    ...
    //     register double s = sin(phi), c = cos(phi);
    //     return Vec2<double>( v_abc.a*c + v_abc.b*s, v_abc.c );
    // }
    ...
    //     register double s = sin(phi), c = cos(phi);
    //     return Vec3<double>( v_abc.a*c + v_abc.b*s, -v_abc.a*s + v_abc.b*c, v_abc.c );
    // }
};
