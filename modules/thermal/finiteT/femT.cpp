...
FiniteElementMethodThermal2DModule::FiniteElementMethodThermal2DModule() :
    maxiterations(10)
{
}
...
void FiniteElementMethodThermal2DModule::delSolver()
{
    delete mA;
    delete mB;
    mA = NULL;
...
void FiniteElementMethodThermal2DModule::setMatrixData()
{
    //(*getMesh)[0].
...
void FiniteElementMethodThermal2DModule::findNewVectorOfTemp()
{
}

void FiniteElementMethodThermal2DModule::calculateT()
{
}

}}} // namespace plask::modules::finiteT
