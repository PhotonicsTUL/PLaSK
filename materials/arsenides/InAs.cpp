...
double InAs::Eg(double T, double eps, char point) const {
    double tEg(0.);
...
double InAs::Dso(double T, double eps) const {
    return ( 0.39 );
}
...
Tensor2<double> InAs::Me(double T, double eps, char point) const {
...
Tensor2<double> InAs::Mhh(double T, double eps, char point) const {
...
Tensor2<double> InAs::Mlh(double T, double eps, char point) const {
