 ...
 */
#ifndef PLASK__AlAsP_H
#define PLASK__AlAsP_H

/** @file
This file contains undoped AlAsP
*/

#include "plask/material/material.hpp"
#include "../arsenides/AlAs.hpp"
#include "../phosphides/AlP.hpp"

namespace plask { namespace materials {

/**
 * Represent undoped AlAsP, its physical properties.
 */
struct AlAsP: public Semiconductor {

    static constexpr const char* NAME = "AlAsP";

    AlAsP(const Material::Composition& Comp);
