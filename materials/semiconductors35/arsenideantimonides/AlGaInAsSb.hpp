 ...
 */
#ifndef PLASK__AlGaInAsSb_H
#define PLASK__AlGaInAsSb_H

/** @file
This file contains undoped AlGaInAsSb
*/

#include <plask/material/material.hpp>
#include "../antimonides/AlSb.hpp"
#include "../antimonides/GaSb.hpp"
#include "../antimonides/InSb.hpp"
#include "../arsenides/AlAs.hpp"
#include "../arsenides/GaAs.hpp"
#include "../arsenides/InAs.hpp"

namespace plask { namespace materials {

/**
 * Represent undoped AlGaInAsSb, its physical properties.
 */
struct AlGaInAsSb: public Semiconductor {

    static constexpr const char* NAME = "AlGaInAsSb";

    AlGaInAsSb(const Material::Composition& Comp);
