#ifndef PLASK__AlGaP_H
#define PLASK__AlGaP_H

/** @file
This file contains undoped AlGaP
*/
...
/**
 * Represent undoped AlGaP, its physical properties.
 */
struct AlGaP: public Semiconductor {

    static constexpr const char* NAME = "AlGaP";

    AlGaP(const Material::Composition& Comp);
