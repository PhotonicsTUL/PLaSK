#ifndef PLASK__AlInP_H
#define PLASK__AlInP_H

/** @file
This file contains undoped AlInP
*/
...
/**
 * Represent undoped AlInP, its physical properties.
 */
struct AlInP: public Semiconductor {

    static constexpr const char* NAME = "AlInP";

    AlInP(const Material::Composition& Comp);
