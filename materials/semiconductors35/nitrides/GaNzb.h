#ifndef PLASK__GaNzb_H
#define PLASK__GaNzb_H

/** @file
This file contains undoped zinc-blende GaN
*/
...
/**
 * Represent undoped zinc-blende GaN, its physical properties.
 */
struct GaNzb: public Semiconductor {

    static constexpr const char* NAME = "GaNzb";
