...
<materials>
  <material name="modal" base="semiconductor">
    <Nr>3.5</Nr>
  </material>
    ...
    <clip back="0" left="0">
      <stack xcenter="0" ycenter="0">
        <stack name="grating3d">
          <cuboid material="modal" dx="{fl*L}" dy="{ft*L}" dz="0.4"/>
          <cuboid material="modal" dx="{L}" dy="{L}" dz="0.4"/>
        </stack>
    ...
    <clip left="0">
      <stack ycenter="0">
        <stack name="grating2d">
          <rectangle material="modal" dy="{ft*L}" dz="0.4"/>
          <rectangle material="modal" dy="{L}" dz="0.4"/>
        </stack>
...
<solvers>
  ...
  <optical name="FOURIER2D" solver="Fourier2D" lib="modal">
