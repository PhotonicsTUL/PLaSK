...
using namespace plask::optical::modal::python;
...
BOOST_PYTHON_MODULE(modal)
{
    ...
    py_enum<ModalBase::Emission>()
        .value("UNDEFINED", ModalBase::EMISSION_UNSPECIFIED)
        .value("TOP", ModalBase::EMISSION_TOP)
        .value("BOTTOM", ModalBase::EMISSION_BOTTOM)
        .value("FRONT", ModalBase::EMISSION_FRONT)
        .value("BACK", ModalBase::EMISSION_BACK)
    ;
