...
const std::vector<std::size_t>& ModalSolver_getStack(const SolverT& self) { return self.getStack(); }

template <typename SolverT>
const std::vector<RectilinearMesh1D>& ModalSolver_getLayerSets(const SolverT& self) { return self.getLayersPoints(); }
