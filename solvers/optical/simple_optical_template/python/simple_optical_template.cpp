...
#define ROOTDIGGER_ATTRS_DOC \
    ...
    u8".. autosummary::\n\n" \
    u8"   ~optical.simple_optical_template.RootParams.alpha\n" \
    u8"   ~optical.simple_optical_template.RootParams.lambd\n" \
    u8"   ~optical.simple_optical_template.RootParams.initial_range\n" \
    u8"   ~optical.simple_optical_template.RootParams.maxiter\n" \
    u8"   ~optical.simple_optical_template.RootParams.maxstep\n" \
    u8"   ~optical.simple_optical_template.RootParams.method\n" \
    u8"   ~optical.simple_optical_template.RootParams.tolf_max\n" \
    u8"   ~optical.simple_optical_template.RootParams.tolf_min\n" \
    u8"   ~optical.simple_optical_template.RootParams.tolx\n\n" \
    u8":rtype: RootParams\n"
...
static py::object SimpleOpticalTemplate_getDeterminant(SimpleOpticalTemplate<Geometry2DType>& self, py::object val)
{
...
BOOST_PYTHON_MODULE(simple_optical_template)
{
    ...
    {CLASS(SimpleOpticalTemplate<Geometry2DCartesian>, "SimpleOpticalCar2D", "Solver performing calculations in 2D Cylindrical geometry by solve Helmholtz equation.")
      METHOD(findMode, findMode, py::arg("lam"));
      PROVIDER(outRefractiveIndex, "");
      PROVIDER(outLightMagnitude, "");
      RO_FIELD(root,
