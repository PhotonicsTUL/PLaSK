...
class Averaging_Test(unittest.TestCase):
    ...
    def testTran(self):
        ...
        self.assertAlmostEqual(prof_tran.array[0,0,0,0], 1.58113883, 5)
        self.assertAlmostEqual(prof_tran.array[0,0,0,1], 1.26491106, 5)
        self.assertAlmostEqual(prof_tran.array[0,0,0,2], 1.58113883, 5)
    ...
    def testLong(self):
        ...
        self.assertAlmostEqual(prof_long.array[0,0,0,0], 1.26491106, 5)
        self.assertAlmostEqual(prof_long.array[0,0,0,1], 1.58113883, 5)
        self.assertAlmostEqual(prof_long.array[0,0,0,2], 1.58113883, 5)
