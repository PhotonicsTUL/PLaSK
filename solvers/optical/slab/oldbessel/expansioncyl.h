#ifndef PLASK__SOLVER__SLAB_OLDEXPANSIONCYL_H
#define PLASK__SOLVER__SLAB_OLDEXPANSIONCYL_H
...
struct OldBesselSolverCyl;

struct PLASK_SOLVER_API ExpansionOldBessel: public Expansion {
     ...
     */
    ExpansionOldBessel(OldBesselSolverCyl* solver);

    virtual ~ExpansionOldBessel() {}
