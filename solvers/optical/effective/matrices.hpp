 ...
 */
#ifndef PLASK__SOLVER_EFFECTIVE_MATRIX_H
#define PLASK__SOLVER_EFFECTIVE_MATRIX_H
...
int geneigenv(cmatrix& A, cmatrix& B, cdiagonal& vals, cmatrix* rightv=NULL, cmatrix* leftv=NULL);
...
// }
inline int geneigenv(cmatrix&& A, cmatrix&& B, cdiagonal& vals, cmatrix* rightv=NULL, cmatrix* leftv=NULL) {
    return geneigenv(A, B, vals, rightv, leftv);
}
...
#endif // PLASK__SOLVER_EFFECTIVE_MATRIX_H
