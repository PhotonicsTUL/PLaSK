 ...
 */
#ifndef PLASK__SOLVER_EFFECTIVE_FORTRAN_H
#define PLASK__SOLVER_EFFECTIVE_FORTRAN_H
...
// compute for a pair of N-by-N complex nonsymmetric matrices
// (A,B), the generalized eigenvalues, and optionally, the left and/or
// right generalized eigenvectors.
#define zggev F77_GLOBAL(zggev,ZGGEV)
F77SUB zggev(const char& jobvl, const char& jobvr, const int& n, dcomplex* a,
             const int& lda, dcomplex* b, const int& ldb, dcomplex* alpha, dcomplex* beta,
             dcomplex* vl, const int& ldvl, dcomplex* vr, const int& ldvr,
             dcomplex* work, const int& lwork, double* rwork, int& info);


#endif // PLASK__SOLVER_EFFECTIVE_FORTRAN_H
