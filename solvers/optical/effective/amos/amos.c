...
static long c__9 = 9;
static double c_b219 = .5;
static double c_b220 = 0.;
static long c__0 = 0;
...
L50:
    ...
    azexp(&fmur, &fmui, &str, &sti);
    pr = str * .5 / t2;
    pi = sti * .5 / t2;
    zdiv(&c_b219, &c_b220, &str, &sti, &ptr, &pti);
    qr = ptr / t1;
    qi = pti / t1;
    s1r = fr;
    s1i = fi;
...
L20:
    ...
    *argr = zetar * fn23;
    *argi = zetai * fn23;
    azsqrt(&sumar, &sumai, &zar, &zai);
    azsqrt(&w2r, &w2i, &str, &sti);
    *zeta2r = str * *fnu;
    *zeta2i = sti * *fnu;
...
L15:
    ...
    azsqrt(&sr, &si, &srr, &sri);
    str = coner + srr;
    sti = conei + sri;
    zdiv(&str, &sti, &tr, &ti, &znr, &zni);
    azlog(&znr, &zni, &str, &sti, &idum);
    *zeta1r = *fnu * str;
    *zeta1i = *fnu * sti;
    *zeta2r = *fnu * srr;
    *zeta2i = *fnu * sri;
    ...
    srr = tr * rfn;
    sri = ti * rfn;
    azsqrt(&srr, &sri, &cwrkr[16], &cwrki[16]);
