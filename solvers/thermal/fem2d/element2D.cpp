...
double Element2D::getdTdX() const { return (0.5*(getNLoRightPtr()->getT() + getNUpRightPtr()->getT()) - 0.5*(getNLoLeftPtr()->getT() + getNUpLeftPtr()->getT())) / getWidth(); }
double Element2D::getdTdY() const { return (0.5*(getNUpLeftPtr()->getT() + getNUpRightPtr()->getT()) - 0.5*(getNLoLeftPtr()->getT() + getNLoRightPtr()->getT())) / getHeight(); }
void Element2D::setT() { mT = (mpNLoLeft->getT() + mpNLoRight->getT() + mpNUpLeft->getT() + mpNUpRight->getT()) * 0.25; }
