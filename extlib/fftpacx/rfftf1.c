...
/* Subroutine */ int rfftf1_(integer *n, integer *in, doublereal *c__, 
	doublereal *ch, doublereal *wa, doublereal *fac)
{
    ...
    integer idl1, modn;
    doublereal tsnm;
    extern /* Subroutine */ int r1f2kf_(integer *, integer *, doublereal *, 
	    integer *, doublereal *, integer *, doublereal *), r1f3kf_(
	    integer *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *), r1f4kf_(integer *, 
	    integer *, doublereal *, integer *, doublereal *, integer *, 
	    doublereal *, doublereal *, doublereal *), r1f5kf_(integer *, 
	    integer *, doublereal *, integer *, doublereal *, integer *, 
	    doublereal *, doublereal *, doublereal *, doublereal *), r1fgkf_(
