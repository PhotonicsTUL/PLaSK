...
/* Subroutine */ int cost1f_(integer *n, integer *inc, doublereal *x, integer 
	...
	lenwrk, integer *ier)
{
    ...
    /* Local variables */
    integer ier1;
    extern /* Subroutine */ int costf1_(integer *, integer *, doublereal *, 
	    doublereal *, doublereal *, integer *), xerfft_(char *, integer *,
	     ftnlen);
