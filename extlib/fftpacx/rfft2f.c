...
/* Subroutine */ int rfft2f_(integer *ldim, integer *l, integer *m, 
	doublereal *r__, doublereal *wsave, integer *lensav, doublereal *work,
	 integer *lenwrk, integer *ier)
{
    ...
    extern /* Subroutine */ int r2w_(integer *, integer *, integer *, integer 
	    *, doublereal *, doublereal *), w2r_(integer *, integer *, 
    ...
    extern /* Subroutine */ int cfftmf_(integer *, integer *, integer *, 
	    ...
	    doublereal *, integer *, integer *), rfftmf_(integer *, integer *,
	     integer *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, integer *, integer *), xerfft_(char *, 
	    integer *, ftnlen);
...
/* VERIFY LENSAV */
    ...
    lwsav = *l + (integer) (log((doublereal) (*l)) / log(2.)) + 4;
    mwsav = (*m << 1) + (integer) (log((doublereal) (*m)) / log(2.)) + 4;
    mmsav = *m + (integer) (log((doublereal) (*m)) / log(2.)) + 4;
...
/* TRANSFORM FIRST DIMENSION OF ARRAY */
    ...
    i__1 = *m * *ldim;
    i__2 = *l + (integer) (log((doublereal) (*l)) / log(2.)) + 4;
