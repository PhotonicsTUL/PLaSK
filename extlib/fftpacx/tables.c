...
/* Subroutine */ int tables_(integer *ido, integer *ip, doublereal *wa)
{
    ...
    /* Local variables */
    integer i__, j;
    doublereal tpi, arg1, arg2, arg3, arg4, argz;
    ...
    /* Function Body */
    tpi = atan(1.) * 8.;
    argz = tpi / (doublereal) (*ip);
    arg1 = tpi / (doublereal) (*ido * *ip);
    i__1 = *ip;
    for (j = 2; j <= i__1; ++j) {
	arg2 = (doublereal) (j - 1) * arg1;
	i__2 = *ido;
	for (i__ = 1; i__ <= i__2; ++i__) {
	    arg3 = (doublereal) (i__ - 1) * arg2;
