...
/* Subroutine */ int sint1f_(integer *n, integer *inc, doublereal *x, integer 
	...
	lenwrk, integer *ier)
{
    ...
    /* Local variables */
    integer ier1;
    extern /* Subroutine */ int sintf1_(integer *, integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, integer *), xerfft_(
	    char *, integer *, ftnlen);
	...
	*ier = 1;
	...
	goto L100;
    } else if (*lensav < *n / 2 + *n + (integer) (log((doublereal) (*n)) / 
	    log(2.)) + 4) {
	*ier = 2;
