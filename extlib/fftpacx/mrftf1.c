	 ...
	 doublereal *c__, doublereal *ch, doublereal *wa, doublereal *fac)
{
    ...
    integer idl1, modn;
    doublereal tsnm;
    extern /* Subroutine */ int mradf2_(integer *, integer *, integer *, 
	    doublereal *, integer *, integer *, doublereal *, integer *, 
	    integer *, doublereal *), mradf3_(integer *, integer *, integer *,
	     doublereal *, integer *, integer *, doublereal *, integer *, 
	    integer *, doublereal *, doublereal *), mradf4_(integer *, 
	    integer *, integer *, doublereal *, integer *, integer *, 
	    doublereal *, integer *, integer *, doublereal *, doublereal *, 
	    doublereal *), mradf5_(integer *, integer *, integer *, 
	    doublereal *, integer *, integer *, doublereal *, integer *, 
