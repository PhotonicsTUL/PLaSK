...
/* Subroutine */ int cmfgkf_(integer *lot, integer *ido, integer *ip, integer 
	*l1, integer *lid, integer *na, doublereal *cc, doublereal *cc1, 
	integer *im1, integer *in1, doublereal *ch, doublereal *ch1, integer *
	im2, integer *in2, doublereal *wa)
{
