...
/* Subroutine */ int rfftb1_(integer *n, integer *in, doublereal *c__, 
	doublereal *ch, doublereal *wa, doublereal *fac)
{
    ...
    integer modn;
    doublereal halfm;
    extern /* Subroutine */ int r1f2kb_(integer *, integer *, doublereal *, 
	    integer *, doublereal *, integer *, doublereal *), r1f4kb_(
	    integer *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *, doublereal *), r1f3kb_(
	    integer *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *), r1f5kb_(integer *, 
	    integer *, doublereal *, integer *, doublereal *, integer *, 
	    doublereal *, doublereal *, doublereal *, doublereal *), r1fgkb_(
